...
func Catalog(product string) []CatalogEntry {
	...
	if product == model.ProductSub2API {
		return []CatalogEntry{
			{ID: "gpt-5.6-sol", Object: "model", DisplayName: "GPT-5.6 Sol", Provider: "openai", Origin: "closed", Capabilities: []string{"chat", "vision", "tools", "reasoning"}, APIFamilies: []string{"openai", "responses"}, AuthRequirement: "api_key", VirtualContextTokens: 1050000, VirtualPriceProfile: "sub2api-standard", ResponseTemplateSet: "openai"},
			{ID: "gpt-5.6-codex", Object: "model", DisplayName: "GPT-5.6 Codex", Provider: "openai-codex", Origin: "closed", Capabilities: []string{"chat", "vision", "tools", "reasoning", "code"}, APIFamilies: []string{"openai", "responses"}, AuthRequirement: "api_key", VirtualContextTokens: 272000, VirtualPriceProfile: "sub2api-standard", ResponseTemplateSet: "openai"},
