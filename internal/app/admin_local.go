...
func compatibilityRoutes(product string) []string {
	routes := map[string][]string{
		...
		model.ProductSub2API: {"/", "/login", "/register", "/dashboard", "/keys", "/usage", "/redeem", "/profile", "/health", "/setup/status", "/api/v1/settings/public", "/api/v1/auth/register", "/api/v1/auth/login", "/api/v1/auth/login/2fa", "/api/v1/auth/refresh", "/api/v1/auth/logout", "/api/v1/auth/me", "/api/v1/auth/revoke-all-sessions", "/api/v1/auth/oauth/bind-token", "/api/v1/auth/oauth/{provider}/start", "/api/v1/auth/oauth/{provider}/callback", "/api/v1/auth/oauth/{provider}/bind/start", "/api/v1/auth/oauth/{provider}/complete-registration", "/api/v1/auth/oauth/{provider}/bind-login", "/api/v1/auth/oauth/{provider}/create-account", "/api/v1/auth/oauth/wechat/payment/{action}", "/api/v1/auth/oauth/pending/{action}", "/api/v1/user/profile", "/api/v1/user/password", "/api/v1/user", "/api/v1/keys", "/api/v1/keys/{id}", "/api/v1/usage", "/api/v1/usage/stats", "/api/v1/usage/errors", "/api/v1/usage/{id}", "/api/v1/usage/dashboard/stats", "/api/v1/usage/dashboard/trend", "/api/v1/usage/dashboard/models", "/api/v1/usage/dashboard/snapshot-v2", "/api/v1/redeem", "/api/v1/redeem/history", "/api/v1/groups/available", "/api/v1/channels/available", "/api/v1/model-plaza", "/api/v1/subscriptions", "/api/v1/models", "/v1/models", "/models", "/v1/models/{model}", "/v1/sub2api/billing", "/v1/messages", "/v1/messages/count_tokens", "/messages/count_tokens", "/v1/chat/completions", "/chat/completions", "/v1/responses", "/responses", "/v1/embeddings", "/embeddings", "/v1/completions", "/completions", "/v1/alpha/search", "/alpha/search", "/v1/usage", "/v1/live", "/v1/live/{call_id}", "/api/event_logging/batch"},
	}
	routes[model.ProductSub2API] = append(routes[model.ProductSub2API],
		"/backend-api/codex/models", "/backend-api/codex/responses", "/backend-api/codex/responses/compact", "/backend-api/codex/alpha/search")
	routes[model.ProductSub2API] = append(routes[model.ProductSub2API],
		"/setup", "/home", "/email-verify", "/auth/callback", "/auth/oauth/callback", "/auth/linuxdo/callback", "/auth/wechat/callback", "/auth/wechat/payment/callback", "/auth/dingtalk/callback", "/auth/dingtalk/email-completion", "/auth/oidc/callback", "/forgot-password", "/reset-password", "/key-usage", "/model-plaza", "/batch-image", "/affiliate", "/available-channels", "/purchase", "/orders", "/payment/qrcode", "/payment/result", "/payment/stripe", "/payment/airwallex", "/payment/stripe-popup", "/monitor", "/docs/batch-image", "/legal/{documentId}", "/custom/{id}", "/admin", "/admin/dashboard", "/admin/ops", "/admin/audit-logs", "/admin/users", "/admin/groups", "/admin/channels", "/admin/channels/pricing", "/admin/channels/monitor", "/admin/subscriptions", "/admin/accounts", "/admin/plugins", "/admin/announcements", "/admin/proxies", "/admin/redeem", "/admin/promo-codes", "/admin/settings", "/admin/risk-control", "/admin/prompt-audit", "/admin/usage", "/admin/affiliates", "/admin/affiliates/invites", "/admin/affiliates/rebates", "/admin/affiliates/transfers", "/admin/orders/dashboard", "/admin/orders", "/admin/orders/plans")
